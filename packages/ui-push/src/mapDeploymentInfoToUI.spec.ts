...
describe('mapping', function () {
    ...
    function mapToUiVersion(deployerInfo: THerdDeployerMetadata): DeploymentUIInfo {
        ...
        if (deployerInfo.deploymentState.timestamp) {
            ...
            return {
                versionInfo: {
                    ...
                    deploymentVersionDeploymentId: deployerInfo.deploymentState.env + deployerInfo.herdSpec.key,
                    dockerImage: deployerInfo.dockerImageTag || 'missing docker image', // TODO Must fix in metadata library
                    dockerImageTag: deployerInfo.dockerImageTag || 'missing docker image tag',
                    ...
                    versionId: deployerInfo.deploymentState.env + deployerInfo.herdSpec.key + deployerInfo.deploymentState.version + deployedAt
                },
                deploymentInfo: {

                    id: deployerInfo.deploymentState.env + deployerInfo.herdSpec.key,
                    displayName: deployerInfo.herdSpec.description || deployerInfo.displayName,
    ...
    it('should map deployer info to UI', () => {
        ...
        const expectedVersionInfo = {
            ...
            "version": "latest",
            "versionId": "devdev-images-plain-deployer999.999.999992019-10-21T14:53:18.000Z"
        }
        ...
        let expectedDeploymentInfo = {
            ...
            "hyperlinks": [{"title": "TestlinkOne", "url": "https://link.to.nowhere"}, {
                "title": "TestLinkTwo",
