...
const loader = require("./image-deployment-planner")(
  inject({
  ...
  describe("image deployer, old style docker labels", function() {
      ...
      let dockerDeployerMetadata = {
        ...
        dockerLabels: {
          ...
          "shepherd.environment.variables":
            "EXPORT1=${EXPORT1},DB_PASS=$MICRO_SITES_DB_PASSWORD",
          "shepherd.git.branch": "master",
          "shepherd.git.hash": "b14892def916aa1fffa9728a5d58f7359f982c02",
          "shepherd.git.url": "https://github.com/Icelandair/shepherd.git",
          "shepherd.lastcommits":
    ...
    describe("missing env variables", function() {
      it("should fail with message indicating label containing problematic env reference.", function(done) {
        loadPlan(dockerDeployerMetadata)
  ...
  describe("is.icelandairlabs backwards compatibility", function() {
    let dockerImageMetadata = {
      ...
      dockerLabels: {
        ...
        "is.icelandairlabs.git.hash":
          "b14892def916aa1fffa9728a5d58f7359f982c02",
        "is.icelandairlabs.git.url":
          "https://github.com/Icelandair/is.icelandairlabs.git",
