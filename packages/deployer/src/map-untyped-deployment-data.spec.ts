...
function expectMappedToMatchExpectedData(deploymentInfo: TK8sDockerImageDeploymentAction, expectedData:THerdK8sMetadata | THerdDeployerMetadata, deploymentType: TDeploymentType) {
...
describe("raw deployment data mapping", function() {
  ...
  it("should map from deployment data 0", () => {
    expectMappedToMatchExpectedData(deploymentData0() as TK8sDockerImageDeploymentAction, expectedK8sDeployment0(), TDeploymentType.Kubernetes)
  })

  it("should map from deployment data 1", () => {
    expectMappedToMatchExpectedData(deploymentData1() as TK8sDockerImageDeploymentAction, expectedK8sDeployment1(), TDeploymentType.Kubernetes)
  })
  ...
  it("should complain if herdSpec.key is undefined", () => {
    try{
      ...
      mapUntypedDeploymentData(deploymentInfo as TK8sDockerImageDeploymentAction)
