...
type TK8sDockerImageDeploymentActionTestDataType = Omit<Omit<IK8sDockerImageDeploymentAction, "deploymentRollouts">, "execute">
...
export function deploymentData1(): TK8sDockerImageDeploymentActionTestDataType {
  ...
  return {
    ...
    "descriptor": "apiVersion: v1\nkind: Service\nmetadata:\n  name: shepherd-ui-service\n  labels:\n    name: shepherd-ui-service\n    environment: dev\nspec:\n  ports:\n    - port: 80 # the port that this service should serve on\n      # the container on each pod to connect to, can be a name\n      # (e.g. 'www') or a number (e.g. 80)\n      name: serviceport\n      targetPort: 3000\n      protocol: TCP\n  # just like the selector in the replication controller,\n  # but this time it identifies the set of pods to load balance\n  # traffic to.\n  selector:\n    app: shepherd-ui-service-pod\n    environment: dev\n---\napiVersion: extensions/v1beta1\nkind: Deployment\nmetadata:\n  name: shepherd-ui-service-deployment\n  annotations:\n    kubernetes.io/change-cause: forShepherdUi\nspec:\n  replicas: 1\n  template:\n    metadata:\n      labels:\n        app: shepherd-ui-service-pod\n        environment: dev\n    spec:\n      containers:\n        - name: shepherd-ui-service-pod\n          image: shepherdorg/shepherd-ui:3.0.3-8d75408\n          imagePullPolicy: Always\n          env:\n            - name: HASURA_ENDPOINT_URL\n              value: wss://iapi.dev.domain.com/shepherd-ui-api/v1/graphql\n          ports:\n            - containerPort: 3000\n              name: service-port\n          livenessProbe:\n            httpGet:\n              path: /\n              port: service-port\n            initialDelaySeconds: 15\n            timeoutSeconds: 4\n            failureThreshold: 2\n            periodSeconds: 30\n          readinessProbe:\n            httpGet:\n              path: /\n              port: service-port\n            initialDelaySeconds: 15\n            timeoutSeconds: 4\n---\napiVersion: extensions/v1beta1\nkind: Ingress\nmetadata:\n  name: shepherd-ui-service-ingress\n  annotations:\n    nginx.ingress.kubernetes.io/ssl-redirect: 'false'\nspec:\n  rules:\n    - host: shepherd-ui.dev.domain.com\n      http:\n        paths:\n          - backend:\n              serviceName: shepherd-ui-service\n              servicePort: 80\n  tls:\n    - hosts:\n        - shepherd-ui.dev.domain.com\n      secretName: services-cert\n",
