...
function identifyDocument(deploymentDocument) {
    try {
        ...
        if (deploymentdocument.metadata) {
            ...
            if (deploymentdocument.metadata.namespace && deploymentdocument.metadata.namespace !== "default") {
                identifyingString = deploymentdocument.metadata.namespace + "_" + identifyingString;
            }
        }
