...
export DOCKER_IMAGE=testenvimage:${SEMANTIC_VERSION}
export MIGRATIONS_DOCKERIMAGE=testenvimage-migrations:0.0.0
...
docker build -t ${DOCKER_IMAGE} \
	...
	--build-arg MIGRATIONS_DOCKERIMAGE="${MIGRATIONS_DOCKERIMAGE}" \
